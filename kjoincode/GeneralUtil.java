...
public class GeneralUtil {	
	...
	public static String testresult = "\\D:\\CAIDA\\final_result_1\\testoutput.txt";
	public static String[] fileSuffix = {"0v","1v","2v","4v","4v","5v","6v","7v","8v","9v"};
	/** parameter for estimation on a single source **/
	public static String dataStreamForFlowSize = "D:\\GeneralFramework\\CAIDA\\output"; // "\\G:\\CAIDA\\traffic\\traffic.txt";		//"\\G:\\CAIDA\\final_result_1\\output.txt";  /* path + "traffic\\CAIDA_data0_statistics_size.txt";*/
	public static String dataSummaryForFlowSize = "D:\\GeneralFramework\\CAIDA\\srcDstSize"; //path + "traffic\\CAIDA_data0_statistics_size.txt";
	public static String dataStreamForFlowSpread = "\\D:\\GeneralFramework\\CAIDA\\output1.txt"; //path + "traffic\\10MPackets.txt";
	//public static String dataStreamForFlowSpread = "\\D:\\CAIDA\\final_result_1\\FlowTraffic2.txt";
	//public static String dataSummaryForFlowSpread = "\\D:\\CAIDA\\final_result_1\\outputdstspread2.txt";//path + "traffic\\10MCardinality.txt";
	...
	public static String dataStreamForFlowSpreadJoin = "\\D:\\GeneralFramework\\CAIDA\\output"; //path + "traffic\\10MPackets.txt";
	public static String dataSummaryForFlowSpreadJoin = "\\D:\\GeneralFramework\\CAIDA\\dstSpread";
	...
	public static ArrayList<Integer> bin = new ArrayList<>(Arrays.asList(1, 2, 4, 8, 16, 32, 64, 128, 256,512,1024, 2048,4096,8192,32768,65536,131072));//16384,
...
System.out.print("go to analyze accuracy");
		while (sc.hasNextLine()) {
			...
			if (Math.abs(shat-s)>5000) System.out.println(maxabserr[binIndex]+"  "+ Math.abs(shat-s)+"  "+entry);
	...
	for (int ii=0;ii<dataFileNumber;ii++) {
		String filePath = filePathPrefix + fileSuffix[ii]+filePathSuffix;
		maxerr = 0;
